...
import { faKey, faSave, faCheck, faExclamationTriangle, faCog } from '@fortawesome/free-solid-svg-icons';
...
export default function ModpackSettingsPage() {
  ...
  return (
    <div className="p-8" style={{ maxWidth: 900, margin: '0 auto', background: '#0f1115', minHeight: '100vh' }}>
      <div className="mb-8">
        <h1 className="text-2xl font-bold mb-2 flex items-center" style={{ color: '#fff' }}>
          <FontAwesomeIcon icon={faCog} className="mr-3" style={{ color: '#3b82f6' }} />
      ...
      >
        <div className="flex items-center gap-3 mb-5">
          <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ background: 'rgba(59, 130, 246, 0.1)' }}>
            <FontAwesomeIcon icon={faKey} style={{ color: '#3b82f6', fontSize: 18 }} />
          </div>
          <div>
            <h2 className="text-lg font-semibold" style={{ color: '#fff' }}>CurseForge API</h2>
            <p style={{ color: '#6b7280', fontSize: 13 }}>Obtenha sua chave em: https://console.curseforge.com/</p>
          </div>
        </div>

        <div className="mb-4">
          <label className="block mb-2 text-sm font-medium" style={{ color: '#a1a5b7' }}>
          ...
          <div className="relative">
            <input
              ...
              onChange={(e) => setSettings({ ...settings, curseforge_api_key: e.target.value })}
          ...
          <p style={{ color: '#6b7280', fontSize: 12, marginTop: 8 }}>
            A chave da API CurseForge permite buscar modpacks diretamente do CurseForge.
            Sem ela, apenas o Modrinth será usado.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            onChange={(e) => setSettings({ ...settings, curseforge_enabled: e.target.checked })}
            className="w-4 h-4 rounded"
          />
          <label htmlFor="curseforge-enabled" style={{ color: '#a1a5b7', fontSize: 14 }}>
      ...
      >
        <div className="flex items-center gap-3 mb-5">
          <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ background: 'rgba(34, 197, 94, 0.1)' }}>
            <FontAwesomeIcon icon={faCheck} style={{ color: '#22c55e', fontSize: 18 }} />
          </div>
          <div>
            <h2 className="text-lg font-semibold" style={{ color: '#fff' }}>Modrinth API</h2>
            <p style={{ color: '#6b7280', fontSize: 13 }}>API pública — não requer chave</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            onChange={(e) => setSettings({ ...settings, modrinth_enabled: e.target.checked })}
            className="w-4 h-4 rounded"
          />
          <label htmlFor="modrinth-enabled" style={{ color: '#a1a5b7', fontSize: 14 }}>
      ...
      <div
        ...
        style={{ background: '#1e2128', border: '1px solid #2a2e37' }}
      >
        <h2 className="text-lg font-semibold mb-4" style={{ color: '#fff' }}>Configurações Padrão</h2>
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => setSettings({ ...settings, default_loader: e.target.value })}
